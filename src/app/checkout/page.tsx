...
const PAYMENT_OPTIONS = [
    { id: 'Pago Móvil', label: 'Pago Móvil', icon: '/assets/images/pago-movil.svg', desc: 'Transferencia bancaria rápida en Bs.' },
    { id: 'Efectivo', label: 'Efectivo', icon: '/assets/images/efectivo.svg', desc: 'Divisas USD o bolívares en mano' },
] as const;
...
export default function CheckoutPage() {
    ...
    const isScheduledInvalid = deliveryType === 'programada' && (!scheduledDateTime || scheduledDateTime < getMinDateTime());
    ...
    const handleDateTimeChange = (val: string) => {
        ...
        if (val && val < currentMin) {
            setErrors((prev) => ({ ...prev, scheduledDateTime: 'Por favor selecciona una fecha y hora futura válida' }));
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between">
                    ...
                    >
                        <div className="w-8 h-8 rounded-xl border border-border flex items-center justify-center group-hover:border-amber-500 group-hover:bg-amber-50 dark:group-hover:bg-amber-950/40 transition-all">
                            <ArrowLeft size={16} className="text-muted-foreground group-hover:text-amber-600 transition-colors" />
                        </div>
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className="text-xs sm:text-sm text-muted-foreground mt-2 max-w-xs mx-auto">
                                Para continuar al checkout, primero añade nuestras deliciosas mieles 100% puras a tu pedido.
                            </p>
                        </div>
                        <Link
                            href="/products"
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                        ...
                                        >
                                            <div className="w-8 h-8 rounded-xl bg-amber-600/20 flex items-center justify-center shrink-0 mt-0.5">
                                                <Zap size={18} className={deliveryType === 'inmediata' ? 'text-stone-950' : 'text-amber-500'} />
                                            </div>
                                            <div>
                                                ...
                                                <div className={`text-[11px] mt-0.5 ${deliveryType === 'inmediata' ? 'text-stone-900/80 font-normal' : 'text-muted-foreground'}`}>
                                        ...
                                        >
                                            ...
                                            <div>
                                                <div className="text-xs sm:text-sm font-bold flex items-center gap-1.5">
                                                    ...
                                                    {deliveryType === 'programada' && <Check size={14} strokeWidth={3} className="text-amber-600 dark:text-amber-400" />}
                                                </div>
                                    ...
                                    {deliveryType === 'programada' && (
                                        ...
                                        >
                                            <div className="space-y-1.5">
                                                <label htmlFor="scheduled-datetime" className="text-xs font-semibold text-muted-foreground flex items-center gap-1.5">
                                            ...
                                            {scheduledDateTime && !errors.scheduledDateTime && (
                                                <div className="flex items-center gap-2 text-xs font-medium text-amber-700 dark:text-amber-300 bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800/50 rounded-xl px-3 py-2">
                                                    ...
                                                    <span>⏰ Entrega programada: <strong>{formatScheduledDateTime(scheduledDateTime)}</strong></span>
                                                </div>
                                            )}
                                        </motion.div>
                                    )}
                            ...
                            <div className="lg:col-span-5 space-y-6 lg:sticky lg:top-24 mt-6 lg:mt-0">
                                            ...
                                            return (
                                                ...
                                                >
                                                    <div className="flex items-center gap-3">
                                                        <Image src={opt.icon} alt={opt.label} width={36} height={36} className="w-9 h-9 shrink-0" />
                                                        <div>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="bg-muted/60 border border-border/80 rounded-2xl p-3.5 text-[11px] text-muted-foreground text-center space-y-1">
                                        ...
                                        <p>
                                            Te responderemos al instante para confirmar la disponibilidad y coordinar la entrega.
                                        </p>
                                    </div>
                                </div>
                            </div>
