  ...
  const benefits = [
    {
      ...
      description:
        'Contiene peróxido de hidrógeno natural y fitonutrientes que ayudan a combatir gérmenes e infecciones.',
    },
    {
      icon: HeartPulse,
      title: 'Rica en Antioxidantes',
      description:
        'Abundante en flavonoides y ácidos orgánicos que combaten los radicales libres y el envejecimiento celular.',
    },
    {
      icon: Zap,
      title: 'Energía Limpia y Sostenida',
      description:
        'Los azúcares naturales no refinados proveen energía inmediata y duradera sin picos de glucosa abruptos.',
    },
    {
      icon: Sparkles,
      title: 'Refuerzo Inmunológico',
      description:
        'Consumir miel pura local ayuda al organismo a desarrollar inmunidad natural frente a alérgenos de temporada.',
    },
    {
      icon: Flame,
      title: 'Alivio para la Garganta',
      description:
        'Recubre y calma naturalmente las vías respiratorias irritadas, siendo un excelente remedio ante la tos.',
    },
    {
      icon: Smile,
      title: 'Favorece la Digestión',
      description:
        'Actúa como prebiótico natural, alimentando las bacterias benéficas de la flora intestinal.',
    },
  ];
