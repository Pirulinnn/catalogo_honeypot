                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-12 lg:items-center">
                    ...
                    >
                        ...
                        <p className="text-stone-700 text-sm sm:text-base leading-relaxed mb-6 font-normal">
                            <strong className="font-semibold text-stone-900">Honey Pot</strong>, el néctar dorado de{' '}
                            <strong className="font-semibold text-stone-900">Venezuela</strong>, tiene sus raíces en{' '}
                        ...
                        <div className="border-l-2 border-amber-500 pl-4 my-2 py-2 pr-3 bg-amber-500/5 rounded-r-2xl space-y-2">
                            <p className="italic text-stone-800 text-sm sm:text-[15px] leading-relaxed">
                                &ldquo;Nuestra miel captura la esencia única de esta región, donde la riqueza de la naturaleza se destila en cada gota.&rdquo;
                            </p>
                            <p className="text-stone-700 text-xs sm:text-sm font-medium leading-relaxed">
                                Descubre la auténtica dulzura de <span className="font-semibold text-stone-900">Honey Pot</span>, una marca que refleja el verdadero sabor venezolano.
                            </p>
                        </div>
                    </motion.div>
                </div>
